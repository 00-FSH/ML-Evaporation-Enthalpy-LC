...
def evaluate_with_multiple_seeds(n_estimators, max_depth, min_samples_split, min_samples_leaf, data, targets):
    ...
    file_name = "D:\pycharm\机器学习\pythonProject\Master3\ML\SMILE\随机种子\RandomForest_all_seed_performance_metrics_0.2.xlsx"
...
def save_predictions_to_excel(y_train, y_pred_train, y_test, y_pred_test, random_seed):
    ...
    # Save to Excel
    file_name = f"D:\pycharm\机器学习\pythonProject\Master3\ML\SMILE\随机种子\RandomForest_predictions_seed_290_0.2.xlsx"
...
def optimize_rf(data, targets):
    ...
    logger = JSONLogger(path="D:\pycharm\机器学习\pythonProject\Master3\ML\SMILE\随机种子\RandomForest_rank12_test.json")
    optimizer.subscribe(Events.OPTIMIZATION_STEP, logger)
    start = time.time()
    optimizer.maximize(init_points=5, n_iter=55)
    with open('D:\pycharm\机器学习\pythonProject\Master3\ML\json_smile\RandomForest_rank12_test.json', 'a', encoding='utf-8', errors='replace') as f:
